...
// prefix/suffix and nesting (`a{b,c{d,e}}`). Expansion applies even inside
// quotes (so `"Analyze {the,all}"` -> "Analyze the"/"Analyze all"); commas that
// are themselves inside quotes stay literal via the quote-aware inner split.
